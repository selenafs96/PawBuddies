...
const ejemploAnimales = [
  {
    ...
    edad: '2 años',
    tipo: 'perro',
    imagen: 'https://eq2imhfmrcc.exactdn.com/wp-content/uploads/2016/08/golden-retriever-650x471.jpg?strip=all',
  },
  {
    id: '2',
    nombre: 'Misi',
    edad: '3 años',
    tipo: 'gato',
    imagen: 'https://images.ctfassets.net/denf86kkcx7r/4IPlg4Qazd4sFRuCUHIJ1T/f6c71da7eec727babcd554d843a528b8/gatocomuneuropeo-97?fm=webp&w=913',
  },
  {
    id: '3',
    nombre: 'Rocky',
    edad: '1 año',
    tipo: 'gato',
    imagen: 'https://img.freepik.com/foto-gratis/primer-disparo-vertical-lindo-gato-europeo-pelo-corto_181624-34587.jpg?semt=ais_hybrid&w=740&q=80',
  },
  {
    id: '4',
    nombre: 'Toby',
    edad: '4 años',
    tipo: 'perro',
    imagen: 'https://eq2imhfmrcc.exactdn.com/wp-content/uploads/2016/08/poodle-caniche.jpg?strip=all',
  },
  {
    id: '5',
    nombre: 'Luna',
