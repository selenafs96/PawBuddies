...
- Cuando queremos que al hacer click en un componente redirija a otra pantalla (como el botón Ver de la lista), hay que envolver ese componente en un <Link> con atributos href="*indicar aquí la ruta de la pantalla a la que queremos ir" y asChild.
